...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        File_External_Storage = Environment.getExternalStorageDirectory() + File.separator + "MessageCaptorAccessibilityService";
...
//        checkPermission();
    ...
    public void removeItem(int position, XListAdapter mAdapter) {
        ...
        new XFileActivity.RemoveLine(File_Withdraw_Msg, p, this).remove();
    }
    ...
    private boolean ifCheckVersion() {
        ...
        XFileActivity xFile = new XFileActivity(this);
        long lastDate;
        try {
            lastDate = Long.parseLong(xFile.readFile(File_Version));
        } catch (NumberFormatException e) {
            String date = String.valueOf(System.currentTimeMillis());
            new XFileActivity(getApplicationContext()).writeFile(date, MainActivity.File_Version);
            return true;
        }
