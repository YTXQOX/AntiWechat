package com.ljstudio.android.antiwechat;
...
import static com.ljstudio.android.antiwechat.Debug.ServerOnConnected;
import static com.ljstudio.android.antiwechat.MainActivity.File_Withdraw;
import static com.ljstudio.android.antiwechat.XBitmap.getImageFileInQQ;
 ...
 */
public class MessageCaptorAccessibilityService extends AccessibilityService {
        ...
        switch (eventType) {
            case AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED:
                ...
                if (xFile.isShowCheckedNotice())
                    new XNotificationActivity(this).printSuccess();
                break;
...
//                    new GetNodes();
    ...
    class Search {
        ...
        Search(String name) {
            ...
            try {
                search = new XFileActivity.Search(MainActivity.File_Dir + name);
            } catch (IOException e) {
                XToast.makeText(getApplicationContext(),
                        "打开软件之前的消息是看不到的").show();
                e.printStackTrace();
...
//                                getHongBao(n3);
    ...
    class TrebleClick implements Runnable {
        ...
        public void run() {
            ...
            new XFileActivity.RemoveLine(name, getApplicationContext()).remove();
