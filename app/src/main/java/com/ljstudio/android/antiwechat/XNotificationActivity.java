...
public class XNotificationActivity extends AppCompatActivity {
    ...
    public XNotificationActivity(Context context, Intent intent) {
        mContext = context;
        manager = (NotificationManager) mContext.getSystemService(Context.NOTIFICATION_SERVICE);
        pendingIntent = PendingIntent.getActivity(mContext, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public void printSuccess() {
        ...
        new XFileActivity(mContext).setNotShowCheckedNotice();
    ...
    public void showInstall() {
        ...
        builder.setContentTitle("MessageCaptorAccessibilityService");
