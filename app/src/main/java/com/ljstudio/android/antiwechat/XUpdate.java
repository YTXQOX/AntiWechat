...
class XUpdate {
    ...
    XUpdate(Context context) {
        ...
        PATH =
                "http://www.qsboy.com/MessageCaptorAccessibilityService/version.html";
    ...
    private void showNoticeDialog() {
        ...
        builder.setPositiveButton("安装", new OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                new XFileActivity(mContext).writeFile(date, MainActivity.File_Version);
                dialog.dismiss();
            }
        });
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    fos.close();
                    is.close();
                    new XNotificationActivity(mContext,intent).showInstall();
